    ...
    DevTools.registerPlugin("domInspector", {
        ...
        startPicker() {
            ...
            this.boundMove = (e) => {
                ...
                if (!el || this.isDevtoolsElement(el)) {
        ...
        selectElement(el) {
            ...
            if (this.isDevtoolsElement(el)) {
                this.api.log("Selected element inside DevTools UI; ignored.");
                return;
            }
            ...
            this.renderDetail = (el) => {
                ...
                detailBox.innerHTML = `
                    ...
                    <div style="margin-top:4px;">
                        <strong>Box:</strong> ${rect.width.toFixed(0)}×${rect.height.toFixed(0)} at 
